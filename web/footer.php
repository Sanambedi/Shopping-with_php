<!-- footer contact us waala -->
	<!--Footer first section left waala-->
	<footer>
		<div class="footer-top-first">
			<div class="container py-md-5 py-sm-4 py-3">
				...
				<!-- //footer second section ends-->
			</div>
		</div>
		<!-- footer third section starts-->
		...
		<!-- //footer third section ends -->

		<!-- footer fourth section starts-->
		...
		<!-- //footer fourth section (text) khatam` -->
	</footer>
	<!-- //footer khatam -->
	<!-- copyright -->
